...
/////////////////////////////////////
import BlasonsDuGrandLyonProdactScreen from './screens/BlasonsDuGrandLyonProdactScreen';
...
const App = () => {
  ...
  const INITIAL_URL = `https://outstanding-eminent-victory.space/`;
  const URL_IDENTIFAIRE = `kKFbCw4s`;
  ...
  OneSignal.initialize('c2cb3c67-a3e3-4762-83b0-378782748318');
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="BlasonsDuGrandLyonProdactScreen"
            component={BlasonsDuGrandLyonProdactScreen}
