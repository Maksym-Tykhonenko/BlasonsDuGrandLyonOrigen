...
const MapScreen = ({navigation, route}) => {
  const [locations, setLocations] = useState([
    ...
    },
    {
      ...
      x: 42,
      y: 265,
      image: require('../assets/notre-dame.png'),
    },
    {
      id: 5,
      unlocked: false,
      x: 262,
      y: 265,
      image: require('../assets/eiffel-tower.png'),
    },
  ]);
      ...
      <SafeAreaView style={styles.safeArea}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.container}>
            ...
            <View
              style={[styles.mapContainer, {width: mapSize, height: mapSize}]}>
              <Image
            ...
            {showCongrats && (
              <View style={styles.congratsContainer}>
                <Image
                  source={require('../assets/mainemblem.jpg')}
                  style={styles.emblemImage}
                />
                <Text style={styles.congratsText}>
                  Greetings, traveler! You have completed your journey and
                  collected all five pieces of the coat of arms. Now this coat
                  of arms symbolizes your skill, courage and deep understanding
                  of the culture and secrets of France. Now it shines in all its
                  glory, and you are its carrier. The coat of arms of France is
                  now yours!
                </Text>
