  ...
  return (
    <ImageBackground
        ...
        <ImageBackground
          ...
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>
              Welcome to Blasons du Grand Lyon!
            </Text>
            <Text style={styles.modalText}>
              Prepare yourself for an exciting adventure where history, puzzles,
              and the coats of arms of Greater Lyon intertwine into one great
              mystery. In this game, you will become a researcher traveling
              across France to restore an ancient coat of arms, unraveling its
              riddles and secrets tied to the majestic lions. Your goal is to
              overcome a series of interactive quizzes, puzzles, and dialogues
              to uncover all the pieces of the coat of arms and discover its
              true meaning. Are you ready to begin your journey and unlock the
              secrets of the heraldry?
            </Text>
            <TouchableOpacity
      ...
      {infoVisible && (
        <View style={styles.modalContent}>
          <Text style={styles.modalTitle}>
            {facts[currentInfoIndex]?.title || 'No Title'}
          </Text>
          <Text style={styles.modalText}>
            {facts[currentInfoIndex]?.text || 'No Content Available'}
          </Text>
          <TouchableOpacity
            style={styles.closeButton}
      ...
      {!modalVisible && !infoVisible && (
        <View style={styles.container}>
          <ScrollView
            ...
            {/* Кнопка CONTINUE GAME появляется только если вторая локация открыта */}
